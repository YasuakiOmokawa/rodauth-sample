class CreatePlans < ActiveRecord::Migration[7.0]
  def change
    create_table :plans do |t|
      ...
      t.boolean 'cc_mail', default: true, comment: '文書送信時にCCを追加できる機能'
      ...
      t.boolean 'contracts_export', default: false, null: false, comment: '文書一覧ダウンロード'
      ...
      t.boolean 'document_file', default: false, null: false, comment: '文書添付ファイル'
      t.boolean 'document_links', default: false, null: false, comment: '関連契約紐付け機能'
      t.boolean 'esign', default: false, null: false, comment: '文書に電子署名を付与'
      ...
      t.integer 'max_contracts', default: 1, null: false, comment: '月に送れる文書の上限数'
      t.boolean 'max_contracts_unlimited', default: false, null: false, comment: '無制限に文書送信可能'
      t.integer 'max_csv_export_count', default: 100, null: false, comment: '文書をCSVで一括作成・送信できる最大数'
      ...
      t.boolean 'tags', default: false, null: false, comment: '文書タグ付'
      t.boolean 'paper_upload', default: false, null: false, comment: '紙の文書'
      ...
      t.boolean 'full_text_search', default: false, null: false, comment: '文書の全文検索'
